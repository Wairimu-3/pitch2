...
def index():
    ...
    title = 'Home - Welcome to Royals Pitch'
    ...
    return render_template('index.html', title=title, interview=interview_piches, product=product_piches,
...
def new_pitch():
    ...
    if pitch_form.validate_on_submit():
        ...
        new_pitch = Pitch(pitch_title=title, pitch_content=pitch, category=category, user=current_user, likes=0,
                          dislikes=0)
